...
class NEMP(Calculator):
    ...
    def __init__(self, skin=1.0, pbc=[0, 0, 0], Field=[0, 0, 0], skin_neigh=20, getneigh=None, fconfig='full_config.json', initatoms=None, properties=['energy', 'forces'], **kwargs):
        ...
        self.Field = jnp.array(np.array(Field).astype(self.np_dtype))
        self.skin = skin
    ...
    def calculate(self, atoms=None, properties=None, system_changes=all_changes):
        ...
        results = self.pes(self.params, positions, self.Field, self.cell, self.disp_cell, neighlist, shifts, self.center_factor, self.species)
